...
$app->post('/api/Breezometer/getSpecificDateAirQuality', function ($request, $response) {
    ...
    $datetime = date('Y-m-d',$strTime)."T".date('H:i:s',$strTime);
    ...
    $data = array("lat"=>$latitude ,"lon"=>$longitude, "key"=>$apiKey, "datetime"=>$datetime);
