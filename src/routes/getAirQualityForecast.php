...
$app->post('/api/Breezometer/getAirQualityForecast', function ($request, $response) {
    ...
    $data = array("lat"=>$latitude ,"lon"=>$longitude, "key"=>$apiKey);
    ...
    if(isset($post_data['args']['hours']))
    {
        $data['hours'] = $post_data['args']['hours'];
    }
